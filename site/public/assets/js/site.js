...
(function () {
  ...
  function header() {
    ...
    <div class="topbar"><div class="container">
      ...
      <div class="links"><a href="/members/#directory">동문 찾기</a><span data-me hidden style="color:var(--gold-300)"></span><a href="/admin/" class="wb-top" title="개발 작업대">◆ 작업대</a><button class="lang-toggle" data-lang-toggle aria-label="Language"><span class="${L==='ko'?'on':''}">KO</span><i>|</i><span class="${L==='en'?'on':''}">EN</span></button></div>
    </div></div>
    <header class="header"><div class="container">
      ...
      <div class="header-actions">
        ...
        <a class="btn ghost sm wb-link" href="/admin/">작업대</a>
    ...
    <div class="mobile-nav" id="mobileNav" aria-hidden="true">
      ...
      <a class="wb-mobile wb-link" href="/admin/"><span>◆ 작업대 <small>Workbench</small></span><i>→</i></a>
  ...
  async function whoami() {
    try { const r = await fetch('/api/me', { cache: 'no-store' }); if (!r.ok) return; const me = await r.json(); window.SNU_ME = me;
      if (!me.name) return;
      document.documentElement.classList.add('snu-in');
